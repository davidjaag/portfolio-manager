...
/* ── PIN INPUT INLINE BUTTON ── */
[data-testid="stAppViewContainer"] [data-testid="stTextInput"]{
    position:relative !important;
}
/* Hide the separate Entrar/Volver buttons — replaced by inline overlay */
[data-testid="stAppViewContainer"] [data-testid="stHorizontalBlock"]:has([data-testid="stBaseButton-primary"]){
...
[data-testid="stAppViewContainer"] [data-testid="stHorizontalBlock"]:has([data-testid="stBaseButton-primary"]) > div:first-child{
    display:none !important;
}
[data-testid="stAppViewContainer"] [data-testid="stHorizontalBlock"]:has([data-testid="stBaseButton-primary"]) > div:last-child{
    min-width:0 !important;width:auto !important;
}
[data-testid="stAppViewContainer"] [data-testid="stHorizontalBlock"]:has([data-testid="stBaseButton-primary"]) button{
...
if not st.session_state.authenticated:
    ...
    # Remove Streamlit UI elements via JS
st.markdown("""
<script>
(function removeStreamlitUI(){
    function clean(){
        ...
        selectors.forEach(function(s){
            var els = window.parent.document.querySelectorAll(s);
...
if page in ("📊 Dashboard", "📊 Mi Portafolio"):
    ...
    if not _is_admin:
        ...
        _pulse_color = "201,162,39" if has_actions else "26,122,74"
        ...
        <div style='background:{status_bg};border-left:5px solid {status_border};
            ...
            <div style='display:flex;align-items:center;gap:10px;margin-bottom:6px;'>
                <span style='display:inline-block;width:11px;height:11px;border-radius:50%;
                    ...
                    animation:blink_dot__ {'1.1s ease-in-out infinite' if has_actions else 'none'};
                    flex-shrink:0;box-shadow:0 0 6px {status_border};'></span>
