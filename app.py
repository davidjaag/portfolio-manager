...
.banner-right{text-align:right;flex-shrink:0;display:flex;flex-direction:column;align-items:flex-end;justify-content:flex-start;}
.banner-greeting{font-size:16px;color:rgba(255,255,255,0.9);margin-bottom:8px;font-weight:500;letter-spacing:0.01em;align-self:flex-end;}
...
if not st.session_state.authenticated:
    ...
    with col:
        ...
        st.markdown(
            ...
            f'border-radius:14px;padding:18px 32px;'
            f'box-shadow:none;">'
            f'<img src="{logo_img}" style="width:170px;display:block;"></div>'
