...
@media(max-width:480px){
    ...
    /* Show sidebar toggle on mobile — multiple selector variants */
    [data-testid="stSidebarCollapsedControl"],
    [data-testid="collapsedControl"],
    button[aria-label="Open sidebar"],
    button[aria-label="Abrir panel lateral"],
    button[kind="header"]{
    ...
    button[aria-label="Open sidebar"] svg{
        fill:#c9a227 !important;stroke:#c9a227 !important;width:20px !important;height:20px !important;
    }
...
if not st.session_state.authenticated:
    ...
    # JS sidebar toggle button for mobile
    st.markdown("""
    <style>
    #mobile-sidebar-btn{
        display:none;
        ...
        background:rgba(13,27,42,0.92);border:1px solid rgba(201,162,39,0.4);
    ...
    #mobile-sidebar-btn span{
        ...
        background:#c9a227;border-radius:2px;
        transition:all 0.3s;
    }
    @media(max-width:768px){
    ...
    <div id='mobile-sidebar-btn' onclick=\"(function(){
...
if page in ("📊 Dashboard", "📊 Mi Portafolio"):
    ...
    if not _is_admin:
        ...
        # Pulse animation CSS — only injected once
        _pulse_color = "234,255,0" if has_actions else "26,122,74"
        _pulse_anim = f"pulse_{_pulse_color.replace(',','_')}"
        st.markdown(f"""
        <style>
        @keyframes {_pulse_anim}{{
            0%,100%{{box-shadow:0 0 0 0 rgba({_pulse_color},0.5),0 2px 12px rgba(0,0,0,0.07);}}
            50%{{box-shadow:0 0 0 8px rgba({_pulse_color},0),0 2px 12px rgba(0,0,0,0.07);}}
        }}
        @keyframes blink_dot_{{}}{{
        ...
        <div style='background:{status_bg};border-left:5px solid {status_border};
                    ...
                    animation:{_pulse_anim} {'2.2s ease-in-out infinite' if has_actions else 'none'};
                    position:relative;'>
            <div style='display:flex;align-items:center;gap:10px;margin-bottom:6px;'>
                <span style='display:inline-block;width:12px;height:12px;border-radius:50%;
                    background:{'#eaff00' if has_actions else status_border};
                    animation:blink_dot__ {'1.0s ease-in-out infinite' if has_actions else 'none'};
                    flex-shrink:0;box-shadow:{'0 0 8px #eaff00,0 0 16px #eaff00' if has_actions else f'0 0 4px {status_border}'};'></span>
                <div style='font-size:18px;font-family:"DM Serif Display",serif;
                    color:#1a2332;line-height:1.3;'>{status_msg}</div>
            </div>
            <div style='font-size:11px;color:#6b7c93;padding-left:21px;'>
