...
.banner-title{font-family:'DM Serif Display',serif;font-size:26px;color:#fff;margin:0;}
...
@media(max-width:480px){
    .app-banner{flex-direction:column;align-items:stretch;gap:0;padding:18px 16px;border-radius:14px;}
    .banner-left{margin-bottom:12px;}
    .banner-right{text-align:center;width:100%;display:flex;flex-direction:column;
        align-items:center;gap:2px;border-top:1px solid rgba(255,255,255,0.12);padding-top:12px;}
    .banner-count{font-size:32px;}
    .banner-count-label{font-size:12px;}
    .banner-greeting{font-size:15px;margin-top:6px;}
...
if not st.session_state.authenticated:
    ...
    /* Reduce gap between PIN input and buttons */
