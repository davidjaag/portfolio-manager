...
.styled-table{width:100%;min-width:600px;border-collapse:collapse;font-size:13px;}
.styled-table th{background:var(--navy2);color:#fff;padding:11px 14px;text-align:center;font-weight:600;font-size:11px;letter-spacing:.05em;text-transform:uppercase;white-space:nowrap;}
.styled-table td{padding:9px 14px;text-align:center;border-bottom:1px solid #e8eef5;white-space:nowrap;}
      ...
      {cards_html_inv}{cards_html_inv}
        ...
        if not history.empty:
            ...
            fig_hist.update_layout(
                height=300, paper_bgcolor="white", plot_bgcolor="#fafbfe",
                font=dict(family="DM Sans", color="#1a2332"),
