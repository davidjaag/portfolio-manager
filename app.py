...
if not st.session_state.authenticated:
    ...
    @media(max-width:520px){
        ...
        .gpanel{padding:20px 16px;border-radius:14px;}
    ...
    <div style='padding:14px 0 0;'>
        ...
        <div style='background:rgba(255,255,255,0.06); border-radius:10px; padding:12px;'>
            ...
            <div style='border-top:1px solid rgba(255,255,255,0.08); padding-top:8px;
                ...
                <span style='font-size:9px; color:#c9a227; font-weight:700; letter-spacing:.1em;
                             text-transform:uppercase;'>USD/MXN</span>
                <span style='font-size:20px; font-weight:800; color:#fff;'>{_tc_sidebar:.2f}</span>
                <span style='font-size:9px; color:rgba(255,255,255,0.35);'>tiempo real</span>
            </div>
        </div>
    </div>
    """, unsafe_allow_html=True)
