...
.banner-greeting{font-size:13px;color:rgba(255,255,255,0.6);margin-bottom:4px;font-weight:400;letter-spacing:0.02em;}
...
if page in ("📊 Dashboard", "📊 Mi Portafolio"):
    ...
    if not _is_admin:
        ...
        st.markdown(f"""
        <div style='font-size:13px;color:#6b7c93;margin-bottom:10px;letter-spacing:0.02em;'>
            {_saludo_inv}, <span style='color:#1a3a5c;font-weight:600;'>{_nombre_inv}</span>
        </div>""", unsafe_allow_html=True)
