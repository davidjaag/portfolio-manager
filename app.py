...
[data-testid="stDeployButton"],[class*="viewerBadge"],[class*="styles_viewerBadge"],
button[title="View fullscreen"],a[href*="streamlit.io"],
...
.banner-greeting{font-size:17px;color:rgba(255,255,255,0.75);margin-top:10px;font-weight:400;letter-spacing:0.01em;}
...
.banner-count{font-family:'DM Serif Display',serif;font-size:38px;color:#fff;line-height:1;}
.banner-count-label{font-size:12px;color:rgba(232,240,248,0.6);margin-top:2px;}
...
@media(max-width:480px){
    ...
    .banner-greeting{font-size:14px;margin-top:0;text-align:right;}
    ...
    with col:
        ...
        if st.session_state.selected_user_login is None:
            ...
            with st.form("pin_form", clear_on_submit=False):
                ...
                with c2:
                    enter = st.form_submit_button("Entrar →", use_container_width=True, type="primary")
            if back:
                st.session_state.selected_user_login = None
                st.session_state.login_error = False
                st.rerun()
