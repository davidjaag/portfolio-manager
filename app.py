...
if not st.session_state.authenticated:
    ...
    @media(max-width:640px){
        [data-testid="stAppViewContainer"] [data-testid="stHorizontalBlock"]{flex-direction:column !important;gap:0 !important;}
        [data-testid="stAppViewContainer"] [data-testid="stHorizontalBlock"] > div{width:100% !important;min-width:0 !important;flex:1 1 100% !important;}
        [data-testid="stAppViewContainer"] [data-testid="stHorizontalBlock"] > div:first-child,
        [data-testid="stAppViewContainer"] [data-testid="stHorizontalBlock"] > div:last-child{display:none !important;}
        .gpanel{padding:24px 20px;border-radius:18px;}
