...
# ══════════════════════════════════════════════════════════════════════════════
    ...
    _rp_ret_raw = None
    if use_sheets and sheet_id:
        try: _rp_ret_raw = load_price_history_from_sheets(sheet_id, _rp)
        except: pass
    if _rp_ret_raw is not None and _rp_target:
        risk_metrics = calc_risk_metrics_bloomberg(_rp_ret_raw, _rp_target,
                           rf=_rp_data.get("rf", 0.0264))
    else:
